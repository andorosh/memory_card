...
class Question():
    #Вопрос, правильный ответ, и три неправильных
...
'Французский'))
question_list.append (Question('Самая большая по площади в мире', 'Россия', 'Канада', 'США', 'Австралия'))
question_list.append (Question('Год рождения А.С. Пушкина?', '1799', '1837', '1800', '2007'))
question_list.append (Question('Какой возраст Владимира Владимировича?', '69', '58', '74', '61'))
...
btn_OK.clicked.connect(click_OK) # по кнопке определяем что будет происходить
window.total = 0
window.score = 0
next_question()
